...
\documentclass[titlepage, ngerman, 14pt]{scrartcl}
	...
	\begin{beweis}[von 2.2]\
		\begin{enumerate}
			...
			\item \begin{enumerate}
			  ...
			  \end{enumerate}
			\item Annahme $b < a$, $\varepsilon \coloneqq \frac{a-b}{2} > 0$ ~ \tikz[baseline=-0.5ex]{  \draw(0,0)--(10,0);
    \foreach \x/\xtext in {0/$$,2/$$,4/$b$,6/$$,8/{\small $a$},10/$$}
      \draw(\x,3pt)--(\x,-3pt) node[below] {\xtext};
      \foreach \x/\xtext in {4.75/$x$,8.75/$y$}
      \draw(\x,2pt)--(\x,-2pt) node[below] {\xtext};
    \draw[decorate,decoration={brace},yshift=2ex]  (2.75,0) -- node[above=0.4ex] {\small $U_{\varepsilon}(b)$}  (5.25,0);
    \draw[decorate,decoration={brace},yshift=2ex] (6.75,0) -- node[above=0.4ex] {\small $U_{\varepsilon}(a)$} (9.25,0);} \\
...
\begin{beweis} ~\\
	...
	$\glqq \Leftarrow \grqq$ $\exists n_{1} \in \N: a_{n_{1}} \in U_{1}(\alpha)$. $\exists n_{2} \in \N: a_{n_{2}} \in U_{\frac{1}{2}}(\alpha)$ und $n_{2} > n_{1}$. $\exists n_{3} \in \N: a_{n_{3}} \in U_{\frac{1}{3}}(\alpha)$ und $n_{3} > n_{2}$. Etc. ... Man erhält eine Teilfolge $(a_{n_{k}})$ von $(a_{n})$ mit
	$$
...
\begin{beweis}
	$\glqq \Rightarrow \grqq$ s.o. $\glqq \Leftarrow \grqq$ ohne Beweis
\end{beweis}
